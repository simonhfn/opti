% test des regions de confiance en utilisant le pas du gradient conjugué tronqué.

clear all;
close all;

%% Tests de Reg de confiance avec le gradient conjugue tronque
disp('###################################################');
disp('## Tests Reg confiance ac grad conjugue tronque  ##');
disp('###################################################');
